...
print("Verifying ans field is now correctly set:\n")

mcq = currentaffairs_mcq.objects.get(id=41)
print(f"MCQ ID 41:")
...
print(f"  ans field: {mcq.ans}")
print(f"  Correct option text: {getattr(mcq, f'option_{mcq.ans}')}")
print("\n✅ ans field is now correctly changing!")
