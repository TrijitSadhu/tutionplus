...
class polity(models.Model):
    ...
    creation_time= models.TimeField(blank=True, null=True)
    question = models.TextField(default='')
    option_1 = models.CharField(max_length=600)
    option_2= models.CharField(max_length=600)
    option_3 = models.CharField(max_length=600)
    option_4 = models.CharField(max_length=600,blank=True, null=True)
    option_5 = models.CharField(max_length=600,null=True,blank=True)
    ans = models.IntegerField (default=1)
    ...
    difficulty = models.CharField(max_length=20,
                  ...
                  default="easy",blank=True,null=True,db_index=True)
    home = models.BooleanField(default=False,db_index=True)
    mocktest = models.BooleanField(default=False,db_index=True)
    new_id=models.CharField(max_length=300,default='',blank=True,null=True,db_index=True)
