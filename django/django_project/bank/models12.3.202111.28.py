...
class total_polity(models.Model):
    ...
    def save(self):
        ...
        self.total_polity_page=int(totall)/3
        ...
        for x in range(1,41):
            ...
            if total !=0:
                ...
                if(int(total)%3==0):
                    total_page=(int(total)/3)
                else:
                    total_page=(int(total)/3)+1
                y='chapter_'+ str(x)
...
class total_history(models.Model):
    ...
    def save(self):
        ...
        self.total_history_page=int(totall)/3
...
class total_geography(models.Model):
    ...
    def save(self):
        ...
        self.total_geography_page=int(totall)/3
...
class total_economics(models.Model):
    ...
    def save(self):
        ...
        self.total_economics_page=int(totall)/3
...
class total_physics(models.Model):
    ...
    def save(self):
        ...
        self.total_physics_page=int(totall)/3
...
class total_biology(models.Model):
    ...
    def save(self):
        ...
        self.total_biology_page=int(totall)/3
...
class total_chemistry(models.Model):
    ...
    def save(self):
        ...
        self.total_chemistry_page=int(totall)/3
