"""
Native (non-Docker) production settings for tutionplus.
...
# ─── Database (reads from .env; native PostgreSQL on localhost) ──────────────
DATABASES = {
    'default': {
...
# ─── Static & Media (native filesystem paths, no Docker volumes) ─────────────
STATIC_URL = '/static/'
...
# Fix UTC timezone assertion for psycopg2 (same as settings_docker.py)
